...
# source: tests/acceptance/fixtures/echo.proto
...
EchoRequest = _reflection.GeneratedProtocolMessageType('EchoRequest', (_message.Message,), dict(
  ...
  __module__ = 'tests.acceptance.fixtures.echo_pb2'
